...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsTemplateList" checkbox="true" fitColumns="false" title="消息模板表" actionUrl="tSSmsTemplateController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="创建人登录名"  field="createBy"  hidden="true"  queryMode="single"  ></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate" formatter="yyyy-MM-dd" hidden="false"  queryMode="single"  ></t:dgCol>
   ...
   <t:dgCol title="模板名称"  field="templateName"  query="true" queryMode="single"  ></t:dgCol>
   <t:dgCol title="模板类型"  field="templateType" query="true" queryMode="single" dictionary="msgTplType" ></t:dgCol>
   <t:dgCol title="模板内容"  field="templateContent"  queryMode="single"  ></t:dgCol>
   ...
   <t:dgToolBar title="查询" icon="icon-search" url="tSSmsTemplateController.do?goUpdate" funname="detail"></t:dgToolBar>
