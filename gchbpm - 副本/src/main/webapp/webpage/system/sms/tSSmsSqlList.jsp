...
<%--   <t:dgCol title="更新日期"  field="updateDate" formatter="yyyy-MM-dd" hidden="true"  queryMode="single"  ></t:dgCol>--%>
   <t:dgCol title="SQL名称"  query="true" field="sqlName"  queryMode="single"  ></t:dgCol>
   <t:dgCol title="SQL内容"  query="true" field="sqlContent"  queryMode="single"  ></t:dgCol>
   ...
   <t:dgToolBar title="查询" icon="icon-search" url="tSSmsSqlController.do?goUpdate" funname="detail"></t:dgToolBar>
