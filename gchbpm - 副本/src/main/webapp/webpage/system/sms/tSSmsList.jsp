...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsList" checkbox="true" fitColumns="false" title="消息发送记录表" actionUrl="tSSmsController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
...
<%--   <t:dgCol title="更新日期"  field="updateDate" formatter="yyyy-MM-dd" hidden="true"  queryMode="single" ></t:dgCol>--%>
   <t:dgCol title="消息标题"  field="esTitle" query="true" queryMode="single" ></t:dgCol>
   <t:dgCol title="消息类型"  field="esType"  query="true" queryMode="single" dictionary="msgType"></t:dgCol>
   <t:dgCol title="发送人"  field="esSender"  queryMode="single" query="true"></t:dgCol>
   <t:dgCol title="接收人"  field="esReceiver"  queryMode="single"></t:dgCol>
   <t:dgCol title="内容"  field="esContent"  queryMode="single" ></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate" formatter="yyyy-MM-dd hh:mm:ss" query="true" queryMode="group" ></t:dgCol>
   <t:dgCol title="发送时间"  field="esSendtime"  formatter="yyyy-MM-dd hh:mm:ss" queryMode="single" ></t:dgCol>
   <t:dgCol title="发送状态"  field="esStatus" query="true"  queryMode="single" dictionary="msgStatus"  ></t:dgCol>
   <t:dgCol title="备注"  field="remark"  queryMode="single" ></t:dgCol>
...
<%--   <t:dgToolBar title="录入" icon="icon-add" url="tSSmsController.do?goAdd" funname="add"></t:dgToolBar>--%>
   <t:dgToolBar title="消息修正" icon="icon-edit" url="tSSmsController.do?goUpdate" funname="update"></t:dgToolBar>
