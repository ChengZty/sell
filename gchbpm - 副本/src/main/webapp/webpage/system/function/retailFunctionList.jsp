...
<div region="center" style="padding: 1px;">
    <t:datagrid name="functionList" title="菜单管理"
                actionUrl="functionController.do?functionGrid&flag=02" idField="id" treegrid="true" pagination="false">
...
<%--         <t:dgFunOpt funname="operationData(id)" title="数据规则"></t:dgFunOpt> --%>
        <t:dgToolBar title="录入" langArg="菜单" icon="icon-add" url="functionController.do?addorupdate&flag=02" funname="addFun"></t:dgToolBar>
        <t:dgToolBar title="编辑" langArg="菜单" icon="icon-edit" url="functionController.do?addorupdate&flag=02" funname="update"></t:dgToolBar>
    </t:datagrid>
</div>
</div>
