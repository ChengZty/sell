...
<t:datagrid name="roleList" title="角色列表" actionUrl="roleController.do?roleGrid" fitColumns="false" extendParams="nowrap:false,"
	...
	<t:dgCol title="角色类别" field="roleType" width="120" replace="后台_01,零售商_02"  query="true"></t:dgCol>
...
<div tools="#tt" class="easyui-panel" title='权限设置' style="padding: 10px;width: 400px;" fit="true" border="false" id="function-panel"></div>
</div>
<div id="tt"></div>
