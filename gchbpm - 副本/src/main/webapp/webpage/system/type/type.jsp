...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
    ...
    <fieldset class="step">
        ...
        <div class="form">
            ...
            <input name="typename" class="inputxt" value="${type.typename }" datatype="*1-30">
            <span class="Validform_checktip">类型范围在1~30位字符</span>
        </div>
    </fieldset>
</t:formvalid>
</body>
