...
<%-- <t:datagrid name="departList" title="组织机构列表" actionUrl="departController.do?departSelectDataGrid" idField="id" checkbox="true" showRefresh="false">
	<t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="组织机构名称" field="departname" width="50"></t:dgCol>
</t:datagrid> --%>
</body>
</html>
