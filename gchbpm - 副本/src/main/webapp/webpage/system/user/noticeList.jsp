...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="noticeList" title="消息" actionUrl="noticeController.do?datagrid" idField="id" fit="true" sortName="createTime" sortOrder="desc">
...
<!-- update-begin Author:xugj  Date:20160330 for：#1012 【平台bug】系统公告列表时间格式不对 -->
 ...
 <!-- update-end Author:xugj  Date:20160330 for：#1012 【平台bug】系统公告列表时间格式不对 -->
   ...
   <t:dgFunOpt funname="doRead(id,isRead)" title="阅读"></t:dgFunOpt>
  </t:datagrid>
  </div>
 </div>
 <script type="text/javascript" charset="utf-8">
  ...
  function doRead(id,isRead){
	  ...
	  var addurl = "noticeController.do?goNotice&id="+id;
		createdetailwindow("消息详情", addurl, 750, 600);
  }
