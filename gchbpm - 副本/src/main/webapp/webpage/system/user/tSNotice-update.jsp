...
// 	}
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" layout="table" action="noticeController.do?doUpdate" tiptype="4" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							<textarea  id="content" style="width: 100%" datatype="*">${tSNoticePage.noticeContent }</textarea>
<%-- 								<input id="noticeContent" name="noticeContent" type="hidden" value='${tSNoticePage.noticeContent}' datatype="*"> --%>
