...
<t:formvalid formid="formobj" refresh="false" dialog="true" action="userController.do?savenewpwdforuser" usePlugin="password" layout="table">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
				<td align="right" width="80px"><label class="Validform_label"> 密码: </label></td>
				<td class="value"><input type="password"  value="" name="password" plugin="passwordStrength" datatype="*6-18" errormsg="" /> <span class="passwordStrength"
			...
			<tr>
				...
				<td class="value"><input id="repassword"  type="password"  recheck="password" datatype="*6-18" errormsg="两次输入的密码不一致！"> <span
