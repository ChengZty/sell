...
<t:datagrid name="rList" title="零售商列表" actionUrl="userController.do?retaileRelationDatagrid&retailer_Type=1&isOther=${isOther }&rId=${rId }" fitColumns="false" extendParams="nowrap:false,"
