				...
				<div class="sidebar" id="sidebar">
					...
					<div class="th-nav-list">
						<ul class="nav nav-list">
							<li class="active">
								<a  href="javascript:addTabs({id:'home',title:'首页',close: false,url: 'loginController.do?acehomeStatistics'});">
									<i class="icon-dashboard"></i>
									<span class="menu-text"> 首页 </span>
								</a>
							</li>
							<t:menu style="aceCustom" menuFun="${menuMap}" funTp="${funTp }"></t:menu>
						</ul><!-- /.nav-list -->
