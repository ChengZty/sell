...
<ul class="nav pull-right usernav">
	<li style="line-height: 43px;"><span style="color: #CC33FF">用户:</span><span style="color: #666633">(${userName })</span> <span style="color: #CC33FF">角色</span>:<span style="color: #666633">${roleName
	}</span></li>
	...
	<ul class="dropdown-menu">
		<li onclick="openwindow('个人信息','userController.do?userinfo')"><a href="javascript:;"><i class="icon-user"></i> 个人信息</a></li>
		<li onclick="add('修改密码','userController.do?changepassword')"><a href="javascript:;"><i class="icon-pencil"></i> 修改密码</a></li>
		<li onclick="openwindow('系统消息','tSSmsController.do?getSysInfos')"><a href="javascript:;"><i class="icon-pencil"></i> 系统消息</a></li>
		<li onclick="add('切换页面风格','userController.do?changestyle')"><a href="javascript:;"><i class="icon-retweet"></i> 切换页面风格</a></li>
	</ul>
	</li>
	...
	<ul class="dropdown-menu">
		<li onclick="exit('loginController.do?logout','确定退出该系统吗 ?',1);"><a href="javascript:;"><i class="icon-off"></i>退出</a></li>
	</ul>
	</li>
</ul>
</div>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 观潮汇 版权所有</li>
<%-- 	<li style="display: inline;">&nbsp;观潮汇 版权所有浏览器:<a title="JEECG Framework -3.6" href="http://www.jeecg.org">JEECG Framework -3.6</a></li> --%>
</ul>
</div>
</footer>
