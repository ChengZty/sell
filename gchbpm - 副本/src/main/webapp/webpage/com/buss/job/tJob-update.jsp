...
<html>
 <head>
  ...
  //编写自定义JS代码
  $(function(){
	  $("#jobSceneCode").val("${tJobPage.jobSceneCode }");
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tJobController.do?doUpdate" tiptype="4">
		...
		<input id="status" name="status" type="hidden" value="${tJobPage.status }">
		<input id="jobType" name="jobType" type="hidden" value="${tJobPage.jobType }">
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
					<select name="jobSceneCode" id="jobSceneCode" readonly="readonly">
			...
			<%-- <tr>
				...
				<td class="value">
				     	<t:dictSelect field="jobCode" type="list" hasLabel="false" datatype="*" defaultVal="${tJobPage.jobCode }" typeGroupCode="jobcode" id="jobCode"></t:dictSelect>
			...
			<tr>
				...
				<td class="value">
				    <input id="title" name="title" type="text" style="width: 150px" class="inputxt" value="${tJobPage.title }" readonly="readonly" datatype="*">
			...
			<tr>
				...
				<td class="value">
				    <input id="jobCode" name="jobCode" type="text" style="width: 150px" class="inputxt" value="${tJobPage.jobCode }" readonly="readonly" datatype="*">
			...
			<tr>
				...
				<td class="value">
				     	 <textarea rows="5" style="width: 100%" name="description" datatype="*">${tJobPage.description }</textarea>
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
				     	 <input id="rate" name="rate" type="text" style="width: 150px" class="inputxt"  value='${tJobPage.rate}'>
			...
			<tr>
				...
				<td class="value">
				     	 <input id="targetNum" name="targetNum" type="text" style="width: 150px" class="inputxt"  value='${tJobPage.targetNum}' datatype="n">
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
				     	 <input id="goldNum" name="goldNum" type="text" style="width: 150px" class="inputxt" value='${tJobPage.goldNum}' datatype="n">
					<span class="Validform_checktip"></span>
