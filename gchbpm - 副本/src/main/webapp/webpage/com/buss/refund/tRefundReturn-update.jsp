...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tRefundReturnController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="subOrderNo" name="subOrderNo" type="text" style="width: 150px"   value='${tRefundReturnPage.subOrderNo}'>
						...
						<td class="value">
						     	 <input id="refundNo" name="refundNo" type="text" style="width: 150px"   value='${tRefundReturnPage.refundNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="userName" name="userName" type="text" style="width: 150px"   value='${tRefundReturnPage.userName}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="userPhone" name="userPhone" type="text" style="width: 150px"   value='${tRefundReturnPage.userPhone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="goodsName" name="goodsName" type="text" style="width: 150px"   value='${tRefundReturnPage.goodsName}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="goodsNum" name="goodsNum" type="text" style="width: 150px"   value='${tRefundReturnPage.goodsNum}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="refundAmount" name="refundAmount" type="text" style="width: 150px"   value='${tRefundReturnPage.refundAmount}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="sellerStatus" name="sellerStatus" type="text" style="width: 150px"   value='${tRefundReturnPage.sellerStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="refundStatus" name="refundStatus" type="text" style="width: 150px"   value='${tRefundReturnPage.refundStatus}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="sellerTime" name="sellerTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${tRefundReturnPage.sellerTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deliveryNo" name="deliveryNo" type="text" style="width: 150px"   value='${tRefundReturnPage.deliveryNo}'>
							<span class="Validform_checktip"></span>
