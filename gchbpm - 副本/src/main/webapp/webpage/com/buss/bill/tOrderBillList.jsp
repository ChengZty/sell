...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tOrderBillList" checkbox="true" fitColumns="false" title="订单结算表" actionUrl="tOrderBillController.do?datagridStore" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="结算单编号"  field="orderBillSn"  hidden="true" query="true" queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="结算状态"  field="obState"  hidden="true" query="true" queryMode="single" dictionary="ob_status" width="120"></t:dgCol>
   ...
   <t:dgCol title="结算对象ID"  field="obPayerId"  hidden="true" query="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="结算对象名称"  field="obPayerName"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="手机号"  field="obPayerPhone"  hidden="true" query="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="零售商ID"  field="obStoreId"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="零售商名称"  field="obStoreName"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   <t:dgDelOpt title="删除" url="tOrderBillController.do?doDel&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="tOrderBillController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tOrderBillController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tOrderBillController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="tOrderBillController.do?goUpdate" funname="detail"></t:dgToolBar>
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'tOrderBillController.do?upload', "tOrderBillList");
}

//导出
function ExportXls() {
	JeecgExcelExport("tOrderBillController.do?exportXls","tOrderBillList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("tOrderBillController.do?exportXlsByT","tOrderBillList");
}
 </script>