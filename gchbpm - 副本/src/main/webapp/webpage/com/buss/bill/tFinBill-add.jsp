...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tFinBillController.do?doAdd" tiptype="1">
...
>
					...
					<td class="value">
					     	 <input id="orderSn" name="orderSn" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="frozenAmount" name="frozenAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="custAmount" name="custAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="storeAmount" name="storeAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="guideAmount" name="guideAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="systemAmount" name="systemAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="helperAmount" name="helperAmount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="custName" name="custName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="goodsStoreName" name="goodsStoreName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="tbStatus" name="tbStatus" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="billSn" name="billSn" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
