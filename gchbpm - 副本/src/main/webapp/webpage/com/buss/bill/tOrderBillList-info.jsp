...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tOrderBillList" checkbox="true" fitColumns="false" title="订单结算表" actionUrl="tOrderBillController.do?datagridStore&obState=${obState}" idField="id" fit="true" queryMode="group">
