...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="basePayTypeController.do?doUpdate" tiptype="4">
					...
					<input id="status" name="status" type="hidden" value="${basePayTypePage.status }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="payType" name="payType" type="text" style="width: 150px"   datatype="*" value='${basePayTypePage.payType}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="payCode" name="payCode" type="text" style="width: 150px"   datatype="*" value='${basePayTypePage.payCode}'>
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="rate" name="rate" type="text" style="width: 50px"  onkeypress="Public.input.moneyInput(this.value)"
					     	 value='${basePayTypePage.rate}' ><font color="red">‰</font>
							<span class="Validform_checktip"></span>
