...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userPayConfigController.do?doUpdate" tiptype="4">
		...
		<table style="width: 900px;margin:20px 40px; background-color:#fff;" cellspacing="0" class="formtable">
			...
			<tr>
				...
				<td style="width: 220px;">
					...
					<input id="storeName" name="storeName" type="text" value="${userPayConfigPage.storeName }" readonly="readonly"/>
				</td>
...
//初始化商户收款的样式
function chackPayment(){
	var pt = ${userPayConfigPage.paymentType } +"";
	if("0" == pt){
		$("#autoclearTd").css('visibility','visible');
		$("#paymentDiv").css('visibility','hidden');
	}else if("0" != pt){
