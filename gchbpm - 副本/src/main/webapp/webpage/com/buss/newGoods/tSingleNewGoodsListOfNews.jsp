...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tNewGoodsList" checkbox="true" fitColumns="true" title="商品列表" sortName="sortNum" sortOrder="desc" actionUrl="tNewGoodsController.do?datagridOfNews&news_Id=${newsId }"
