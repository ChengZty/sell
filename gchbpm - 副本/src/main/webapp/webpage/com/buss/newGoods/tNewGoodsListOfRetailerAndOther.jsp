...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tNewGoodsList" checkbox="false" fitColumns="false"  title="商品列表" sortName="sortNum" sortOrder="desc" actionUrl="tNewGoodsController.do?datagridOfVisiable"
...
<%--    <t:dgCol title="活动价"  field="activityPrice"    queryMode="single"  width="80"></t:dgCol> --%>
   ...
   <t:dgCol title="商品状态"  field="goodsStatus" align="center" replace="草稿箱中_0,待上架_3,销售中_4,已下架_5" query="true"  queryMode="single" width="120" ></t:dgCol>
