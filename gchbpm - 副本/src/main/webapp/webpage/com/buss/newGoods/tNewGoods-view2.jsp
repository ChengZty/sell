 ...
 <div style="width: 1280px;margin: auto;">
  <t:formvalid formid="goods_view"  dialog="false" usePlugin="password" layout="table" btnsub="btn" action="tNewGoodsController.do?doUpdate" tiptype="4" >
					...
					<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
							...
							<tr>
								<td colspan="6">
                					<table id="goods_detail" style="width: 100%;min-height: 200px" cellpadding="0" cellspacing="1" class="formtable">
	                					...
	                					<tr valign="top">
	                						<td width="25%">
	                							<div style="width: 100%">${descList[0].goodsDesc }</div>
	                						</td>
	                						<td width="25%">
	                							<div style="width: 100%">${descList[1].goodsDesc }</div>
	                						</td>
	                						<td width="25%">
	                							<div style="width: 100%">${descList[2].goodsDesc }</div>
	                						</td>
	                						<td width="25%">
	                							<div style="width: 100%">${descList[3].goodsDesc }</div>
	                						</td>
	                					</tr>
                					</table>
								</td>
...
<script src = "webpage/com/buss/newGoods/tNewGoods.js"></script>