...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tNewGoodsList" checkbox="false" fitColumns="true" title="商品列表" sortName="sortNum" sortOrder="desc" actionUrl="tNewGoodsController.do?datagridOfGift&giftRuleId=${giftRuleId }&rId=${retailerId }"
