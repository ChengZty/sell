...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPayRecordController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="orderNo" name="orderNo" type="text" style="width: 150px" class="inputxt"  value='${tPayRecordPage.orderNo}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="payAmount" name="payAmount" type="text" style="width: 150px" class="inputxt"  value='${tPayRecordPage.payAmount}'>
							<span class="Validform_checktip"></span>
