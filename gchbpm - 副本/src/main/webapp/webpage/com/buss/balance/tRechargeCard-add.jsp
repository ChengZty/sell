...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tRechargeCardController.do?doAdd"  tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="cardName" name="cardName" type="text" style="width: 150px" class="inputxt"
				...
				<tr>
					...
					<td class="value">
					     	 ...
					     	 <img id="prePic" src="" style="background-color: rgba(68, 111, 128, 0.67)"  width="100px" height="150px"    />
					     	 <input id="cardPic" name="cardPic" type="hidden" datatype="*" >
							<span class="Validform_checktip"></span>
