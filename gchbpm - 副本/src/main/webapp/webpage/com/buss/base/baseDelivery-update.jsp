...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="baseDeliveryController.do?doUpdate" tiptype="1">
					...
					<input id="status" name="status" type="hidden" value="${baseDeliveryPage.status }">
					<input id="deliveryCode" name="deliveryCode" type="hidden" value="${baseDeliveryPage.deliveryCode }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deliveryName" name="deliveryName" type="text" style="width: 150px"   datatype="*" value='${baseDeliveryPage.deliveryName}'>
