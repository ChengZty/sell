...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tGuideRankWordsController.do?doAdd" tiptype="4">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="rankStart" name="rankStart" type="text" datatype="n" style="width: 150px" class="inputxt">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="rankEnd" name="rankEnd" type="text" style="width: 150px" class="inputxt">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="words" name="words" type="text" style="width: 350px" maxlength="30" class="inputxt"  datatype="*" >
							<span class="Validform_checktip"></span>
