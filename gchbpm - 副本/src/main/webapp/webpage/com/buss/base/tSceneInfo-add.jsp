...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="tSceneInfoController.do?doAdd" tiptype="4" beforeSubmit="setPicContent()" callback="backList">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="title" name="title" type="text" style="width: 350px" class="inputxt" maxlength="25" datatype="*">
				...
				<tr>
					...
					<td class="value">
					    ...
					    <img id="prePic" src="" style="background-color: rgba(68, 111, 128, 0.67)"  width="375px" height="223px"    />
					    <input id="coverPic" name="coverPic" type="hidden" value="" />
				...
				<tr>
					...
					<td class="value" height="400">
					    ...
					    <img id="prePic2" src="" style="background-color: rgba(68, 111, 128, 0.67)"  width="270px" height="320px"    />
					    <input id="indexPic" name="indexPic" type="hidden" value="" />
