...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="baseActivityController.do?doUpdate" callback="goBack"  tiptype="4">
					...
					<input id="status" name="status" type="hidden" value="${baseActivityPage.status }">
...
<!-- 					<input id="newsContext" name="newsContext" type="hidden" > -->
						<script id="content"   type="text/plain" style="width:99%;">${baseActivityPage.newsContext}</script>
