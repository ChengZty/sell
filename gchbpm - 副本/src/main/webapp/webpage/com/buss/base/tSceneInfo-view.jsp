 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 350px" class="inputxt"  value='${tSceneInfoPage.title}'>
					...
					<td class="value">
					    <img id="prePic2" src="${tSceneInfoPage.indexPic }"  width="180px" height="320px"   />
						</td>
					</tr>
					<tr>
					<td align="right">
		   ...
		   if(obj!=null&&obj.length>0){
			    var html='';
		   		for(var i=0;i<obj.length;i++){
		   	   			...
		   	   			+'<div class="ndd-annotation-box" style="width: 100px; height: 45px;"><div class="del-pic-map" onclick="delPic(this)">×</div><a src="'+obj[i].goodsId+'"><div class="ndd-annotation-content"><div onclick="findGoods(this)">'+obj[i].p+'</div></div></a></div></div></div>';
		   	   	}
