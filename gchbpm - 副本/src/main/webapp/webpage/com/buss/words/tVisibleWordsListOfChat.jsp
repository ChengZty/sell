...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tVisibleWordsList" checkbox="true" fitColumns="false" extendParams="nowrap:false," title="撩客话术" 
  actionUrl="tVisibleWordsController.do?datagridOfChat" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="批量设置可见" icon="icon-add" url="tVisibleWordsController.do?doBatchAdd&wordsType=4" funname="doShowAllSelect"></t:dgToolBar>
 ...
 function reviewbytab() {
		...
		createdetailwindow("撩客话术","tChatWordsController.do?goUpdate&load=detail&id="+id,700,400);
	}
 //新增可见话术(wordsType 1:顾客，2：商品，3：活动，4：撩客)
