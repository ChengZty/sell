...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tMembershipController.do?doUpdate" tiptype="4">
					...
					<input id="status" name="status" type="hidden" value="${tMembershipPage.status }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*" maxlength="30"      value='${tMembershipPage.name}'>
					...
					<tr>
						...
						<td class="value">
					     	 ...
					     	 <input id="headPic" name="headPic" type="hidden" value="${tMembershipPage.headPic }" >
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="discount" name="discount" type="text" style="width: 150px" class="inputxt"  
									              datatype="d"  value='${tMembershipPage.discount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="faceValueStart" name="faceValueStart" type="text" style="width: 150px" class="inputxt"  
									                datatype="n"     value='${tMembershipPage.faceValueStart}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="faceValueEnd" name="faceValueEnd" type="text" style="width: 150px" class="inputxt"  
									   value='${tMembershipPage.faceValueEnd}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						<textarea style="width: 98%;height: 100px" id="remark" name="remark" maxlength="300">${tMembershipPage.remark}</textarea>
							<span class="Validform_checktip"></span>
