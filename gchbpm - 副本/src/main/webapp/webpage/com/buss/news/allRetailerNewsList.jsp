...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tNewsList" checkbox="true" fitColumns="false" extendParams="nowrap:false," title="话题列表" sortName="createDate" sortOrder="desc" actionUrl="tNewsController.do?datagrid&isRet=A" idField="id" fit="true" queryMode="group">
...
<%--    <t:dgCol title="话题分类"  field="newsType"   queryMode="single" formatterjs="replaceCode"  width="150"></t:dgCol> --%>
   <t:dgCol title="话题分类"  field="newsType"   queryMode="single" replace="${newsTypeArr }" query="true"  width="80"></t:dgCol>
