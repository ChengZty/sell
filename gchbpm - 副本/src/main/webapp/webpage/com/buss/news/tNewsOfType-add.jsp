...
<!--   <script type="text/javascript" src="plug-in/uploadify/jquery.uploadify-3.1.js"></script> -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false"  layout="table" action="tNewsController.do?doAdd" callback="backList2" beforeSubmit="setContent()" tiptype="4">
		...
		<table style="width: 95%;height: 100%" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value"  width="450px;" >
					     	 <input id="title" name="title" type="text" style="width: 320px" maxlength="30"  datatype="*2-60" >
				...
				<tr height="40">
					<td class="upload" colspan="6" align="center">
						...
						<a href="javascript:back2()" class="easyui-linkbutton l-btn" id="btn_reset" iconCls="icon-back">返回</a>
					</td>
				</tr>
			</table>
		</div>
...
<script src = "webpage/com/buss/news/tNews.js?v=1.17"></script>
