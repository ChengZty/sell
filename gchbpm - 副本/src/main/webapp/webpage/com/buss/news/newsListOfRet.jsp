...
<!-- 话题列表选择关联商品 -->
  ...
  <t:datagrid name="newsList" checkbox="true" fitColumns="false"  title="话题列表" extendParams="nowrap:false," sortName="createDate" sortOrder="desc" actionUrl="templateNewsController.do?datagrid" idField="id" fit="true" queryMode="group">
