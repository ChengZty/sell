...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tNewsList" checkbox="true" fitColumns="false" extendParams="nowrap:false," title="话题列表" sortName="createDate" sortOrder="desc" actionUrl="tNewsController.do?datagrid&isRet=0" idField="id"  queryMode="group">
...
<%--    <t:dgCol title="话题分类"  field="newsType" query="true" queryMode="single" dictionary="t_news_type,code,name,status = 'A' and platform_type='1' "  width="120"></t:dgCol> --%>
   <t:dgCol title="话题分类"  field="newsType" queryMode="single" replace="${newsTypeArr }" query="true" width="120"></t:dgCol>
