...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSmsAutographController.do?doUpdate" tiptype="1">
					...
					<input id="status" name="status" type="hidden" value="${tSmsAutographPage.status }">
					<input id="retailerId" name="retailerId" type="hidden" value="${tSmsAutographPage.retailerId }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="autographName" name="autographName" type="text" style="width: 150px" class="inputxt" value="${tSmsAutographPage.autographName }">
				...
				<tr>
					...
					<td class="value">
					     	 <select id="autographStatus" name="autographStatus" style="width: 150px" value="">
 ...
 <script type="text/javascript">
 $("#autographStatus").val(${tSmsAutographPage.autographStatus });
 </script>
