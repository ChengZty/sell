...
<html>
 <head>
  <title>t_sms_send_template</title>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSmsSendTemplateController.do?doUpdate" tiptype="4">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="templateName" name="templateName" type="text" style="width: 300px" class="inputxt" value='${tSmsSendTemplatePage.templateName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="autographName" name="autographName" hidden="true" value='${tSmsSendTemplatePage.autographName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <textarea id="content" name="content" style="width: 300px" rows="5" maxlength="480" onkeyup="setPreviewHtml()">${tSmsSendTemplatePage.content}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="url" name="url" type="text" style="width: 300px" class="inputxt" onkeyup="setPreviewHtml()" value='${tSmsSendTemplatePage.url}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="contentEnd" name="contentEnd" type="text" style="width: 300px" class="inputxt" onkeyup="setPreviewHtml()" value='${tSmsSendTemplatePage.contentEnd}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="contentEnd2" name="contentEnd2" type="text" style="width: 300px" class="inputxt" onkeyup="setPreviewHtml()" value='${tSmsSendTemplatePage.contentEnd2}'>
							<span class="Validform_checktip"></span>
  ...
  <script type="text/javascript">
  $(function() {
	  $("#autographId").val("${tSmsSendTemplatePage.autographId }");
	  setPreviewHtml();
  });
  </script>	
