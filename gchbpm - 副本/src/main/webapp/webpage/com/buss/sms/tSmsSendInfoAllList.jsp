...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSmsSendInfoList" checkbox="false" fitColumns="false" title="短信推送列表" actionUrl="tSmsSendInfoController.do?datagridOfAll" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="零售商"  field="realname" width="100"></t:dgCol>
