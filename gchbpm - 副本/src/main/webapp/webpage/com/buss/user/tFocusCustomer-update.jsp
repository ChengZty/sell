...
<html>
 <head>
  ...
  $(document).ready(function(){
	  ...
	  $("#phoneRegShop").val("${tFocusCustomerPage.phoneRegShop}");
...
//   }
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true"  layout="table" action="tFocusCustomerController.do?doUpdate" tiptype="4">
		...
		<input id="toGuideId" name="toGuideId" type="hidden" value="${tFocusCustomerPage.toGuideId }"> --%>
		
		<input id="isUseApp" name="isUseApp" type="hidden" value="${tFocusCustomerPage.isUseApp }">
		<input id="unOrder" name="unOrder" type="hidden" value="${tFocusCustomerPage.unOrder }">
				...
				errormsg="生日格式不正确!" ignore="ignore"> <span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							...
							<label class="Validform_label" style="display: none;">顾客分类</label>
						</td>
						<td align="right">
							<label class="Validform_label">
								登记店铺:
						...
						<td class="value">
							...
							<input id="phoneRegShopName" name="phoneRegShopName" type="hidden"	value="${tFocusCustomerPage.phoneRegShopName}">
