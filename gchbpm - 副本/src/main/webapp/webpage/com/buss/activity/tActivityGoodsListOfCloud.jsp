...
<%@include file="/context/mytags.jsp"%>
  <t:datagrid name="tActivityGoodsList" checkbox="true" fitColumns="false" title="云仓活动商品" actionUrl="tActivityGoodsController.do?datagrid&type=2&activity_Id=${activity_Id}&content_Id=${content_Id}&rId=${rId}" idField="id" fit="true" queryMode="group">
	 ...
	 gridname="tActivityGoodsList";
		var activityId = "${activity_Id }";
		 ...
		 if(typeof(windowapi) == 'undefined'){
			 $.dialog({
					content: "url:tGoodsController.do?goodsList&retailer_Type=2&activityId="+activityId,
					lock : true,
					title:"选择活动商品",
					width:900,
					height: 600,
