...
<%@include file="/context/mytags.jsp"%>
  <t:datagrid name="tRetailerRelationList" checkbox="true" fitColumns="false" title="零售商关系表" actionUrl="tRetailerRelationController.do?datagrid&retailerId=${retailerId }&otherRetailerType=${otherRetailerType }" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="其他零售商名字"  field="otherRetailerId"    dictionary="t_s_user,id,realname,user_type='02' and retailer_type='2' and status = 'A' "  width="120"></t:dgCol>
 ...
 function batchAdd(){
 	 gridname="tRetailerRelationList";
 		 ...
 		 if(typeof(windowapi) == 'undefined'){
 			 $.dialog({
 					content: "url:userController.do?cloudListForRetailer&rId=${retailerId}",
 					lock : true,
 					title:"选择云商",
 					width:500,
 					height: 500,
