...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="storeList" checkbox="false" fitColumns="true" title="断码商品列表" sortName="createDate" sortOrder="desc" actionUrl="tGoodsController.do?storeDatagrid&type=${type }"
...
<%--    <t:dgCol title="现价"  field="currentPrice"    queryMode="single"  width="120"></t:dgCol> --%>
 ...
 $(document).ready(function(){
	//修改库存后刷新顶部库存
	 var stockLessNow= "${stockLessNow}";
	 if(stockLessNow!=""){
		 window.top.jQuery('#noticeCount-1').text(stockLessNow);
	 }
 });
