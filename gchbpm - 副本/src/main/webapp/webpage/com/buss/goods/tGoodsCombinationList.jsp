...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tGoodsCombinationList" checkbox="false" extendParams="nowrap:false," fitColumns="true" title="商品组合列表" actionUrl="tGoodsCombinationController.do?datagrid&goods_status=${goods_status }"
