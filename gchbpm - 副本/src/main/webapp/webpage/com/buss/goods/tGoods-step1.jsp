 ...
 -->   
    ...
    <div class="wrapper_search">
        ...
        <div align="center" style="margin-top: 20px">
			<span>
                    <form id="post_form" method="post" action="tGoodsController.do?goAdd" >
...
<!-- 						<input  id="button_back" value="返回" type="button" onclick="window.location.href='tGoodsController.do?retailerList'" class="submit" /> -->
