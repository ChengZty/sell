...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="false" usePlugin="password" btnsub="btn" layout="table"  action="tExcludeRuleController.do?doUpdate" tiptype="4" callback="goback">
...
<%-- 						<t:choose hiddenName="brandId" hiddenid="id" url="tExcludeRuleController.do?findBrands" name="brandList" --%>
