...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tGoodsList" checkbox="true" fitColumns="true" title="商品列表" actionUrl="tGoodsController.do?datagrid2&goods_status=4&retailer_Type=${retailer_Type }&activity_Id=${activityId }" 
...
<%--    <t:dgCol title="活动价"  field="activityPrice"    queryMode="single"  width="100"></t:dgCol> --%>
   <t:dgCol title="最低价"  field="lowestPrice"    queryMode="single"  width="100"></t:dgCol>
   ...
   <t:dgCol title="点击量"  field="goodsCollect"  align="center"  queryMode="single" width="80"></t:dgCol>
