...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="storeList" checkbox="false" fitColumns="true" title="零库存列表" sortName="createDate" sortOrder="desc" actionUrl="tGoodsController.do?storeDatagrid&type=${type }"
...
<%--    <t:dgCol title="现价"  field="currentPrice"    queryMode="single"  width="120"></t:dgCol> --%>
 ...
 $(document).ready(function(){
	 //修改库存后刷新顶部库存
	 var stockZeroNow= "${stockZeroNow}";
	 if(stockZeroNow!=""){
		 window.top.jQuery('#noticeCount-0').text(stockZeroNow);
	 }
 		//给时间控件加上样式
