...
<div class="easyui-layout" fit="true">
  ...
  sortName="goodsUpdateTime" sortOrder="desc" idField="id" fit="true" queryMode="group" extendParams="nowrap:false,">
   ...
   <t:dgCol title="场景"  field="sceneType"  hidden="true"  queryMode="single" ></t:dgCol>
   ...
   <t:dgCol title="原价"  field="originalPrice"    queryMode="single" width="100"></t:dgCol>
