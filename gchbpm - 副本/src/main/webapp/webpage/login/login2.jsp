...
<!--               <i class="ace-icon fa fa-leaf green"></i> -->
              <i ><img src="plug-in/ace/img/logo.ico"/></i>
              	 g+后台管理系统
            </h1>
            <h5 class="blue" id="id-company-text">&copy; 观潮汇版权所有</h5>
          </div>
                  ...
                  <div class="space-6"></div>
                      <label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<input type="text"  name="userName" class="form-control" placeholder="请输入用户名"  id="userName"  value="" onkeypress="sub()"/>
									<i class="ace-icon fa fa-user"></i>
								</span>
                      </label>
                      <label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<input type="password" name="password" class="form-control" placeholder="请输入密码" id="password"  value="" onkeypress="sub()"/>
									<i class="ace-icon fa fa-lock"></i>
								</span>
                      </label>
                      <label class="block clearfix">
                        <div class="input-group">
                          <input type="text" style="width:150px" name="randCode" class="form-control" placeholder="请输入验证码" onkeypress="sub()"  id="randCode" />
