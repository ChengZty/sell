(function($, win, undef) {
	...
	var tipmsg = {
		...
		w : {
			"*" : "can not empty!",
			"*6-16" : "Please fill in any of 6 to 16 - bit characters!",
			"n" : "Please fill in the numbers!",
			"n6-16" : "Please fill out the 6 to 16 digits!",
			"s" : "You cannot enter a special character!",
			"s6-18" : "Please fill out the 6 to 18 - bit characters!",
			"p" : "Please fill out the zip code!",
			"m" : "Please fill in the phone number!",
			"e" : "Wrong email address format!",
			"url" : "Please fill in url address!",
			"w1" : "You must enter a letter or can be numbers, the underscore character!"
		},
		def : "Please fill in the correct information!",
		undef : "datatype undefined!",
		reck : "Two times to enter the content inconsistencies!",
		r : "Pass information verify!",
		c : "Checking information…",
		s : "Please{fill in|select}{0|information}!",
		v : "The information is not verified, please waitting…",
		p : "Submitting data…"
	}
	$.Tipmsg = tipmsg;
