...
(function(){
    ...
    var video = {},
        ...
        uploadFile,
//        serverPath = editor.getOpt('serverPath');
        serverPath = top.location.origin;
    ...
    function createPreviewVideo(url){
        ...
        var videoHtml = '';
          if(conUrl.lastIndexOf(".mp4")!="-1"||conUrl.lastIndexOf(".MP4")!="-1"){//mp4
        	  videoHtml = "<video height='280' width='420' src=\""+conUrl+"\" controls></video>";
		  }else{
			  videoHtml =  '<embed class="previewVideo" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
		        ' src="' + conUrl + '"' +
		        ' width="' + 420  + '"' +
		        ' height="' + 280  + '"' +
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                $.ajax({
        			async : false,//同步
        			dataType : 'json',
        			url : serverPath+"/systemController.do?getQNUptoken&c=1",// 请求的action路径
        		...
        		var name = new Date().Format("MMddhhmmss")+data.name;
        		data["key"]=code+"/uploadvideo/"+time+"/"+name;
            });
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    console.log(json);
                    if (json.state == 'SUCCESS'||json.key) {
                    	json.url = json.key;
                    	json.type = file.type;
