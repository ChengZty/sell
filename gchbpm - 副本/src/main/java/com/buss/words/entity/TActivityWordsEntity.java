 ...
 */
@Entity
@Table(name = "t_activity_words", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TActivityWordsEntity implements java.io.Serializable {
	...
	/**活动分类ID  来源于t_content_category中category_type为SPHD的ID*/
	...
	@Column(name ="ACTIVITY_TYPE_ID",nullable=true,length=10)
	public java.lang.Long getActivityTypeId(){
		return this.activityTypeId;
	}

	public void setActivityTypeId(java.lang.Long activityTypeId){
