 ...
 */
@Entity
@Table(name = "t_visible_words", schema = "")
@SuppressWarnings("serial")
public class TVisibleWordsEntity implements java.io.Serializable {
	public static String WORDS_TYPE_CUST = "1";//顾客话术
	public static String WORDS_TYPE_GOODS = "2";//商品话术
	public static String WORDS_TYPE_ACTIVITY = "3";//活动话术
	public static String WORDS_TYPE_CHAT = "4";//撩客话术
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  资讯ID
	 */
	@Column(name ="WORDS_ID",nullable=true,length=36)
