 ...
 */
@Entity
@Table(name = "t_recharge_card", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TRechargeCardEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.math.BigDecimal  面额
	 */
	@Column(name ="FACE_VALUE",nullable=true,scale=2,length=12)
	...
	@Column(name ="CARD_NAME",nullable=true,length=50)
	...
	@Column(name ="CARD_PIC",nullable=true,length=150)
