 ...
 * @date 2016-09-06 10:50:14
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_scene_pics", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TScenePicsEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="SCENE_ID",nullable=true,length=36)
	 ...
	 */
	@Column(name ="ORDER_NUM",nullable=true,length=1)
	 ...
	 */
	@Column(name ="PIC_MAP_CONTENT",nullable=true,length=32)
