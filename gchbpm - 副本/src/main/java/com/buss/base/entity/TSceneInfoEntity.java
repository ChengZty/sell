 ...
 */
@Entity
@Table(name = "t_scene_info", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TSceneInfoEntity implements java.io.Serializable {
	/**主键*/
	...
	//场景图片
	private List<TScenePicsEntity> detailPics = new ArrayList<TScenePicsEntity>();
	/**
	...
	@Column(name ="INDEX_PIC",nullable=true,length=150)
	public java.lang.String getIndexPic() {
		return indexPic;
	}

	public void setIndexPic(java.lang.String indexPic) {
	...
	@Transient
	public List<TScenePicsEntity> getDetailPics() {
		return detailPics;
	}

	public void setDetailPics(List<TScenePicsEntity> detailPics) {
