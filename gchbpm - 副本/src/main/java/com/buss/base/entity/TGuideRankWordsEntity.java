 ...
 */
@Entity
@Table(name = "t_guide_rank_words", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TGuideRankWordsEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.lang.Integer  起始排名
	 */
	@Column(name ="RANK_START",nullable=true,length=8)
	 ...
	 *@param: java.lang.Integer  起始排名
	 */
	public void setRankStart(java.lang.Integer rankStart){
		this.rankStart = rankStart;
	}
	/**
	 *方法: 取得java.lang.Integer
	 *@return: java.lang.Integer  结束排名
	 */
	@Column(name ="RANK_END",nullable=true,length=8)
	...
	/**
	 *方法: 设置java.lang.Integer
	 *@param: java.lang.Integer  结束排名
	 */
	public void setRankEnd(java.lang.Integer rankEnd){
