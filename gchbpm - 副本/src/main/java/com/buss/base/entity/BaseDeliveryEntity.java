 ...
 */
@Entity
@Table(name = "base_delivery", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class BaseDeliveryEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  物流编码
	 */
	@Column(name ="DELIVERY_CODE",nullable=true,length=32)
