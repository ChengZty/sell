 ...
 */
@Entity
@Table(name = "t_weixin_user", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TWeixinUserEntity implements java.io.Serializable {
	private static final String SEX_M = "1";//男
	private static final String SEX_F = "2";//女
	/**主键*/
	...
	public boolean equals(Object obj) {
		TWeixinUserEntity user = (TWeixinUserEntity) obj;
		if(
