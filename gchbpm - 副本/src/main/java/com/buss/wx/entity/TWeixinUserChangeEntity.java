 ...
 */
@Entity
@Table(name = "t_weixin_user_change", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TWeixinUserChangeEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  特权json组
	 */
	@Column(name ="PRIVILEGE",nullable=true,length=250)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  特权json组
	 */
	...
	@Override
	//判断微信用户的性别，昵称，头像，国家，省，市等信息，如果全都一致则返回true
	public boolean equals(Object obj) {
		TWeixinUserChangeEntity user = (TWeixinUserChangeEntity) obj;
		if(
			(user.getSex()+"").equals(this.sex+"")&&
			(user.getNickname()+"").equals(this.nickname+"")&&
			(user.getHeadimgurl()+"").equals(this.headimgurl+"")&&
			(user.getCountry()+"").equals(this.country+"")&&
			(user.getProvince()+"").equals(this.province+"")&&
			(user.getCity()+"").equals(this.city+"")
		){
			return true;
		}
		return false;
