 ...
 */
@Entity
@Table(name = "t_content_news_type", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TContentNewsTypeEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  资讯分类ID
	 */
