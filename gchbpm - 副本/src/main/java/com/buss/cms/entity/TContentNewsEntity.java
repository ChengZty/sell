 ...
 */
@Entity
@Table(name = "t_content_news", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TContentNewsEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  资讯类型ID
	 */
