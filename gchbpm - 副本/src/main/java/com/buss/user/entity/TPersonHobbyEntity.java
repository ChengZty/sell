 ...
 * @Description: 管家梦想表
 * @author zhangdaihao
 * @date 2016-03-21 11:26:07
 * @version V1.0   
 *
 */
@Entity
@Table(name = "t_person_hobby", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
@Where(clause= " status = 'A'")
public class TPersonHobbyEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="HOBBY",nullable=true,length=36)
