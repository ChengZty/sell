 ...
 */
@Entity
@Table(name = "t_price_change", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TPriceChangeEntity implements java.io.Serializable {
	public static final String PRICETYPE_1 = "1";//现价
	public static final String PRICETYPE_2 = "2";//活动价
	public static final String PRICETYPE_3 = "3";//最低价
	/**主键*/
