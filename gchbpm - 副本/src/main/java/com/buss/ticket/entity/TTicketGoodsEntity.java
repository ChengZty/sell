...
/**   
 * @Title: Entity
 * @Description: 优惠券商品 20170626修改，加入类型 1：商品，2品牌
 ...
 */
@Entity
@Table(name = "t_ticket_goods", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TTicketGoodsEntity implements java.io.Serializable {
	public static final String TYPE_GOODS = "1"; //商品
	public static final String TYPE_BRANDS = "2"; //品牌
	/**主键*/
