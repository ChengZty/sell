 ...
 */
@Entity
@Table(name = "t_retailer_relation", schema = "")
@Where(clause = " status = 'A' ")
@SuppressWarnings("serial")
public class TRetailerRelationEntity implements java.io.Serializable {
	/**id*/
	...
	/**其他零售商类型*/
	@Excel(name="其他零售商类型")
	private java.lang.String otherRetailerType;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  其他零售商类型
	 */
	@Column(name ="OTHER_RETAILER_TYPE",nullable=true,length=1)
	public java.lang.String getOtherRetailerType(){
		return this.otherRetailerType;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  其他零售商类型
	 */
	public void setOtherRetailerType(java.lang.String otherRetailerType){
		this.otherRetailerType = otherRetailerType;
	}
}
