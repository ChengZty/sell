 ...
 */
@Entity
@Table(name = "t_guide_recommend_classify", schema = "")
@Where(clause="status = 'A'")
@SuppressWarnings("serial")
public class TGuideRecommendClassifyEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="classify_Id",nullable=true,length=36)
