 ...
 */
@Entity
@Table(name = "t_commission_store_rule", schema = "")
@SuppressWarnings("serial")
public class TCommissionStoreRuleEntity implements java.io.Serializable {
	/**佣金分配类型*/
	...
	/**佣金分配类型*/
	@Excel(name="佣金分配类型")
	private java.lang.String ctype;//1.未绑定管家	2.签约管家	3.非签约管家
	/**类型名称**/
	...
	/**佣金分配规则*/
	private List<TCommissionStoreRuleEntity> cinfoList = new ArrayList<TCommissionStoreRuleEntity>();
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  佣金分配类型
	 */
	...
	@Column(name ="sid",nullable=true,length=36)
	...
	@Transient
	public List<TCommissionStoreRuleEntity> getCinfoList() {
		return cinfoList;
	}

	public void setCinfoList(List<TCommissionStoreRuleEntity> cinfoList) {
