...
//	DEFAULT_STYLE("ace","main/ace_main","metro", "ACE平面风格"),
	DEFAULT_STYLE("acele","main/ace_main","metrole", "ACE风格"),
	SHARP_STYLE("acele1","main/ace_main1","metrole", "ACE风格"),
//	CUSTOM_STYLE("aceCustom","main/ace_custom_oa","metrole", "ACE定制风格"),
	CUSTOM_STYLE("aceCustom","main/ace_custom_newmenu","metrole", "ACE定制风格");
//	NEW_MENU_STYLE("aceNewMenu","main/ace_custom_newmenu","metrole", "ACE定制风格");
...
//	ACE_STYLE("ace","main/ace_main","metro", "ACE平面风格");
	 ...
	 * @return
	 */
	public static SysThemesEnum toEnum1(String style) {
		if (StringUtil.isEmpty(style)) {
			return SHARP_STYLE;
        }
		for(SysThemesEnum item : SysThemesEnum.values()) {
	...
	public static SysThemesEnum toEnum2(String style){
		if (StringUtil.isEmpty(style)) {
			return CUSTOM_STYLE;
        }
		for(SysThemesEnum item : SysThemesEnum.values()) {
