...
public class CommonServiceImpl implements CommonService {
	 ...
	 * 根据实体名获取对象
	 */
	public <T> T flushEntity(Class entityName, Serializable id) {
	...
	public List<ComboTree> comboTreeWithLevel(List all,ComboTreeModel comboTreeModel,List in,boolean b,int level) {
        return commonDao.comboTreeWithLevel(all, comboTreeModel, in, b,level);
	}
	public List<ComboTree> comboTreeWithLevelOfCategory(List all,ComboTreeModel comboTreeModel,List in,boolean b,int level) {
		return commonDao.comboTreeWithLevelOfCategory(all, comboTreeModel, in, b,level);
	}
	...
	public String getOrderNo(String orderType) {
	    return this.commonDao.getOrderNo(orderType);
	}
	
	/**sql获取数据并转成对应的实体list(sql列名（别名）要和实体一致)
	 * @param <T>
	 * @param sql
	 * @param clazz
	 * @return
	...
	public <T> List<T> findObjForJdbc(String sql,Class<T> clazz) {
		return commonDao.findObjForJdbc(sql, clazz);
	}
}
