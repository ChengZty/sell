...
public interface CommonService {
     ...
     * @return List<ComboTree>
	 */
	public List<ComboTree> comboTreeWithLevel(List<?> allList,ComboTreeModel comboTreeModel, List<?> in,boolean recursive,int level);
	/**
	 * 根据模型生成JSON
	 * @param all 全部对象
	 * @param in 已拥有的对象
	 ...
	 * @return List<ComboTree>
	 */
	public List<ComboTree> comboTreeWithLevelOfCategory(List<?> allList,ComboTreeModel comboTreeModel, List<?> in,boolean recursive,int level);
	...
	/**
	 * 通过JDBC查找对象集合,使用指定的检索标准检索数据并分页返回数据
	 */
