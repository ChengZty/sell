...
public class MenuTag extends TagSupport {
	...
	protected String funTp;//菜单类型，login1登录进来的值为1
...
//		{	sb.append("<div id=\"nav\" style=\"display:none;\" class=\"easyui-accordion\" fit=\"true\" border=\"false\">");
		...
		if(style.equals("ace"))
		{
			sb.append(ListtoMenu.getAceMultistageTree(menuFun,funTp));
		}
		if(style.equals("aceCustom"))
		{
			sb.append(ListtoMenu.getAceMultistageTree(menuFun,funTp));
		}
		if(style.equals("diy"))
	...
	public void setFunTp(String funTp) {
		this.funTp = funTp;
	}
