...
public class UploadTag extends TagSupport {
	...
	protected Integer queueSizeLimit=999;//上传最大文件数
	protected String fileSizeLimit="15MB";//文件大小限制
...
//				sb.append("win.tip(d.msg);");
				...
				sb.append("case -100:");
				sb.append("$.messager.alert('错误','上传的文件数量已经超出系统限制的"+queueSizeLimit+"个文件');");
				sb.append("break;");
				sb.append("case -110:"
				+"$.messager.alert('错误提示','文件 大小超出系统限制的"+fileSizeLimit+")大小');"
				+"break;"
				+"case -120:"
