...
//			String langjs = StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/mutiLang/zh-cn.js\"></script>", "{0}", lang);
			String langjs = "<script type=\"text/javascript\" src=\"plug-in/mutiLang/zh-cn.js\"></script>";
			sb.append(langjs);
...
//				sb.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/designer/easyui/locale/{0}.js\"></script>", "{0}", lang));	
				sb.append("<script type=\"text/javascript\" src=\"plug-in/designer/easyui/locale/zh-cn.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/syUtil.js\"></script>");
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
				...
				sb.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/tools/curdtools_{0}.js?20160809\"></script>", "{0}", "zh-cn"));
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/easyuiextend.js\"></script>");
			...
			if(oConvertUtils.isIn("layer", types)){
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/layer/skin/layer.css\" />");
				sb.append("<script src=\"plug-in/layer/layer.js\" type=\"text/javascript\"></script>");
			}
