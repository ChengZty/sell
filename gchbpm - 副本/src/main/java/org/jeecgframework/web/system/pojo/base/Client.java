...
//	private Map<String, TSFunction> functions;//后面菜单不用这个
//	private Map<Integer, List<TSFunction>> functionMap;//后面菜单不用这个
	private List<FunctionVo> functionList;//菜单列表(具有树结构的列表) 20171120新增
