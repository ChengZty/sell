...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		Object fileobj = systemService.flushEntity(fileClass, fileid);
	...
	public AjaxJson delObjFile(HttpServletRequest request) {
		...
		TSAttachment attachment = systemService.flushEntity(TSAttachment.class,fileKey);
		String subclassname = attachment.getSubclassname(); // 子类类名
		Object objfile = systemService.flushEntity(MyClassLoader.getClassByScn(subclassname), attachment.getId());// 子类对象
